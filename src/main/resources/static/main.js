...
fetch('http://localhost:2020/api/admin/users/')
    .then(res => res.json())
...
fetch('http://localhost:2020/api/admin/roles/')
    .then(res => res.json())
    .then(data => {
        allRoles = data;
...
document.getElementById('deleteUserForm').addEventListener('submit', (e) => {
    e.preventDefault();
    fetch("http://localhost:2020/api/admin/" + document.getElementById('delId').value, {
        method: 'DELETE',
        headers: {
...
document.getElementById('newUserForm').addEventListener('submit', (e) => {
    ...
    const fetchFunction = async () => {
        const fetchedData = await
            fetch("http://localhost:2020/api/admin/", {
                method: 'POST',
                headers: {
...
document.getElementById('editUserForm').addEventListener('submit', (e) => {
    ...
    const fetchFunction = async () => {
        const fetchedData = await fetch("http://localhost:2020/api/admin/" + idForm, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json'
            },
